...
F_DEFAULT_SPEED_MOVE  = 400
F_DEFAULT_SPEED_PRINT = 300
N_PEN_DOWN_DELAY = 400  # delay (ms) for the pen to go down before the next move
N_PEN_UP_DELAY   = 200  # delay (ms) for the pen to up down before the next move
...
class EggBot(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("--penUpSpeed",
                                     ...
                                     dest="penUpSpeed", default=F_DEFAULT_SPEED_MOVE,
                                     help="Speed (step/sec) while pen is up.")
        self.OptionParser.add_option("--penDownSpeed",
                                     action="store", type="int",
                                     dest="penDownSpeed", default=F_DEFAULT_SPEED_PRINT,
